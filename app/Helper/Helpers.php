...
class Helpers {
    ...
    public static function formatTimeCarbon($data)
    {
        return Carbon::createFromFormat('H:i:s',$data)->format('H:i');
    }

    public static function generatePersonalCalender($employeeID,$curriculumYearID=null,$year=null)
    {
    ...
    public static function ReturnResponseAPI($code,$message,$result)
    {
