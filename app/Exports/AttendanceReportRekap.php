...
class AttendanceReportRekap implements FromView
{
    ...
    public function view(): View
    {
        ...
        foreach($dataPegawai as $key => $value){
            ...
            if($value['RelasiPegawai']['jenis_pegawai'] == "Pegawai"){
                $dataKehadiran[$key]['absen'] = PersonalCalender::CountAbsenPegawai($value['RelasiPegawai']['id'],$this->month,$this->year,$value['RelasiPegawai']['tanggal_bergabung'],Carbon::today())->count();
            }else{
                $dataKehadiran[$key]['absen'] = PersonalCalender::CountAbsenGuru($value['RelasiPegawai']['id'],$this->month,$this->year,$value['RelasiPegawai']['tanggal_bergabung'],Carbon::today())->count();
            }
